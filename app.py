...
st.markdown("""
    <style>
        ...
        .stApp {
            # background: linear-gradient(to right, #3d2e9e , #3f11d6);
...
st.markdown("Prepared by **Shiva Pandala** for the **AICTE Internship Cycle 2 by S4F**")
# === Project Links ===
st.markdown("---")
st.markdown("### 🔗 Connect & Explore More")
st.markdown("[📁 GitHub Repository](https://github.com/ShivaNetha1/EV_vehicle_charge_demand)")
st.markdown("[💼 LinkedIn Profile](https://www.linkedin.com/in/shiva-pandala-243914229/)")
